...
public class MailSend {
    public void sendMail()
    {
        try{
            ...
            String user = "sarra.ferchichi@esprit.tn";
            String pass = "informatique1997";
            String to = "sarra.ferchichi@esprit.tn";
            String from = "Russia";
    ...
    public  void sendMailWithHTML(){
      ...
      String from = "sarra.ferchichi@esprit.tn";
      ...
      properties.setProperty("mail.user", "sarra.ferchichi@esprit.tn");
      properties.setProperty("mail.password", "informatique1997");
      // Setup mail server
